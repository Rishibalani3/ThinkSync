          ...
          <div className="px-4 lg:px-6 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <motion.button
                ...
                className="lg:hidden p-2.5 w-full text-center rounded-xl text-gray-700 dark:text-gray-200 hover:bg-gray-100/80 dark:hover:bg-gray-800/80 transition-all duration-300"
              >
                <motion.div
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="w-full  lg:hidden fixed top-24 left-1/2 transform -translate-x-1/2 w-[95%] max-w-md z-40"
          >
