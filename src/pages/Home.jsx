...
const Home = () => {
  const [posts, setPosts] = useState([
    ...
    },
    {
      ...
      content: 'Random thought: The best ideas often come when you\'re not actively trying to think of them. Maybe we need more "thinking breaks" in our daily routines. 💭',
      type: 'thought',
